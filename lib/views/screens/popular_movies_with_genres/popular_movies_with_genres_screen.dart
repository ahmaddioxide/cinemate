                    ...
                    children: [
                      Expanded(
                        child: ListView.builder(
                          itemCount: popularMoviesWithGenresResponse.results.length,
                          itemBuilder: (context, i) {
                            final movie = popularMoviesWithGenresResponse.results[i];
                            return MovieCard(
                      ...
                      PageIndicator(
                        ...
                        onTap: (int pageClicked) {
                          ref.read(popularMoviesWithGenresPageNumberProvider.notifier).setPageNumber(pageClicked);
                        },
